...
export default function ProjectCard({ image, link, title }) {
            ...
            <a className=" relative p-2 group" key={project.title}>
              <div className="grid grid-cols-4 p-1  group-hover:shadow-xl dark:bg-[#2427313d] rounded-md   transition duration-200 ease-in-out">
                ...
                <div className="col-span-3 px-4 relative ">
                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 absolute ${locale === 'ar' ? 'left-2' : 'right-2'} top-2 hidden group-hover:block transition-all text-gray-600`} viewBox="0 0 20 20" fill="currentColor">
