        ...
        <div className="flex items-center py-2 w-16 mx-auto justify-between">
          ...
          >
            <a>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="text-gray-600 dark:text-gray-400" width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#9e9e9e" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          >
            <a>
              <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-600 dark:text-gray-400" width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#9e9e9e" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
