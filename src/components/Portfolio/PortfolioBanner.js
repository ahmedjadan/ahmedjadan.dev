  ...
  return (
    <div className="max-w-6xl mx-auto px-2">
      ...
      <div className="pt-8 mt-12 grid grid-rows-4 grid-cols-4 gap-4 outline-black">
        <div className="col-start-2 col-span-2 bg-gray-300 p-4 outline-black">
          responsive
        </div>
        <div className=" row-span-2 row-start-1 row-end-4 col-start-1 col-end-1 bg-purple-300 ">
          welcome
        </div>
        <div className="col-start-2 col-end-5 bg-indigo-300 p-4 row-start-2 row-end-4">
          {' '}
          hello
        </div>
      </div>
