              ...
              <div className="flex flex-col" key={project.title}>
                ...
                <div className="py-4 text-gray-600 dark:text-gray-200">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <div className="flex items-center text-sm md:text-base dark:text-gray-200 dark:hover:text-gray-300 text-gray-500 hover:text-gray-700 transition-all">
                      <Link href={`portfolio/${project.details}`}>
                        <a className={`${locale === 'ar' ? 'pl-2' : 'pr-2'} `}>
                          {' '}
